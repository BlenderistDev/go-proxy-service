...
var file_proxy_proto_rawDesc = []byte{
	...
	,
}
...
var file_proxy_proto_goTypes = []interface{}{
	(*Url)(nil),    // 0: proxy.Url
	(*Answer)(nil), // 1: proxy.Answer
}
var file_proxy_proto_depIdxs = []int32{
	0, // 0: proxy.Proxy.get:input_type -> proxy.Url
	1, // 1: proxy.Proxy.get:output_type -> proxy.Answer
...
type ProxyClient interface {
	Get(ctx context.Context, in *Url, opts ...grpc.CallOption) (*Answer, error)
}
...
func (c *proxyClient) Get(ctx context.Context, in *Url, opts ...grpc.CallOption) (*Answer, error) {
	out := new(Answer)
...
type ProxyServer interface {
	Get(context.Context, *Url) (*Answer, error)
}
...
func (*UnimplementedProxyServer) Get(context.Context, *Url) (*Answer, error) {
...
func _Proxy_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProxyServer).Get(ctx, req.(*Url))
	}
